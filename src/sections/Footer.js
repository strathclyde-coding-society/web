            ...
            {/* <div className="bg-black border-t-4 border-slate-50"> */}
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    ...
                    <div class="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                        <a href="https://discord.com/invite/zbPVc68kX7"><i className="bi bi-discord ml-1 px-1"></i></a>
                        <a href="https://www.instagram.com/strathcoding/"><i className="bi bi-instagram ml-1 px-1"></i></a>
                        <a href="https://www.linkedin.com/company/strathcoding/"><i className="bi bi-linkedin ml-1 px-1"></i></a>
