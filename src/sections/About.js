                        ...
                        <div className="container m-auto px-6 text-slate-50 md:px-12 xl:px-6">
                            <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
                                ...
                                <div className="md:7/12 lg:w-6/12">
                                    <h2 className="text-xs text-indigo-600 tracking-widest font-medium title-font mb-1">Compotors are kewl.</h2>
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-between items-center my-4">
                                        ...
                                        <div className="flex flex-col justify-center items-center p-3 text-indigo-600">
                                            <div className="flex space-x-3 items-center ">
                                                <span className="text-6xl sm:text-8xl font-bold">200</span>
                                                <span className="text-2xl sm:text-4xl font-bold">+</span>
                                            </div>
                                            <p className="text-indigo-500">Members</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
